...
describe('ERC721SoftStakingLocked Tests', function () {
  before(async function() {
    ...
    const staking = await deploy('ERC721SoftStakingLocked', nft.address, token.address, ethers.utils.parseEther('0.00006'))

    await bindContract('withNFT', 'ERC721Mock', nft, signers)
    await bindContract('withToken', 'ERC20Mock', token, signers)
    await bindContract('withStaking', 'ERC721SoftStakingLocked', staking, signers)
